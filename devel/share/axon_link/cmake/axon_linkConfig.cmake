...
if("TRUE" STREQUAL "TRUE")
  set(axon_link_SOURCE_PREFIX /home/ubuntu/agv_lf/agv/src/axon_link)
  set(axon_link_DEVEL_PREFIX /home/ubuntu/agv_lf/agv/devel)
  ...
  set(axon_link_INSTALL_PREFIX /home/ubuntu/agv_lf/agv/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'axon_link' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'eee <eee@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'axon_link' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/agv_lf/agv/src/axon_link/${idir}'.  Ask the maintainer 'eee <eee@todo.todo>' to fix it.")
    endif()
...
set(axon_link_EXPORTED_TARGETS "axon_link_generate_messages_cpp;axon_link_generate_messages_lisp;axon_link_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${axon_link_dep}_FOUND)
      find_package(${axon_link_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${axon_link_dep} REQUIRED ${depend_list})
  endif()
