...
(cl:defmethod cl:initialize-instance :after ((m <Taobot>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Taobot)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name taobot_link-msg:<Taobot> is deprecated: use taobot_link-msg:Taobot instead.")))

(cl:ensure-generic-function 'motorA_encoder-val :lambda-list '(m))
(cl:defmethod motorA_encoder-val ((m <Taobot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader taobot_link-msg:motorA_encoder-val is deprecated.  Use taobot_link-msg:motorA_encoder instead.")
  (motorA_encoder m))

(cl:ensure-generic-function 'motorA_dir-val :lambda-list '(m))
(cl:defmethod motorA_dir-val ((m <Taobot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader taobot_link-msg:motorA_dir-val is deprecated.  Use taobot_link-msg:motorA_dir instead.")
  (motorA_dir m))

(cl:ensure-generic-function 'motorB_encoder-val :lambda-list '(m))
(cl:defmethod motorB_encoder-val ((m <Taobot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader taobot_link-msg:motorB_encoder-val is deprecated.  Use taobot_link-msg:motorB_encoder instead.")
  (motorB_encoder m))

(cl:ensure-generic-function 'motorB_dir-val :lambda-list '(m))
(cl:defmethod motorB_dir-val ((m <Taobot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader taobot_link-msg:motorB_dir-val is deprecated.  Use taobot_link-msg:motorB_dir instead.")
  (motorB_dir m))

(cl:ensure-generic-function 'motorC_encoder-val :lambda-list '(m))
(cl:defmethod motorC_encoder-val ((m <Taobot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader taobot_link-msg:motorC_encoder-val is deprecated.  Use taobot_link-msg:motorC_encoder instead.")
  (motorC_encoder m))

(cl:ensure-generic-function 'motorC_dir-val :lambda-list '(m))
(cl:defmethod motorC_dir-val ((m <Taobot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader taobot_link-msg:motorC_dir-val is deprecated.  Use taobot_link-msg:motorC_dir instead.")
  (motorC_dir m))

(cl:ensure-generic-function 'voltage-val :lambda-list '(m))
(cl:defmethod voltage-val ((m <Taobot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader taobot_link-msg:voltage-val is deprecated.  Use taobot_link-msg:voltage instead.")
  (voltage m))
