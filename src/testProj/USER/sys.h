...
extern u8 Flag_Qian,Flag_Hou,Flag_Left,Flag_Right,Flag_sudu,Flag_Direction; //蓝牙遥控相关的变量
extern u8 Flag_Stop,Flag_Show;                               //停止标志位和 显示标志位 默认停止 显示打开
extern int Target_A,Target_B,Target_C;                      //电机目标速度
...
extern u8 rxbuf[8],txbuf[8],Rxbuf[16];
extern int AZ,GZ;
extern float Pitch,Roll,Yaw; 
extern int temp,temp2,temp3,count_temp,flag;
/////////////////////////////////////////////////////////////////  
