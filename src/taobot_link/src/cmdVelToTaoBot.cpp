...
uint8_t* changeToOmniSpeed(float x_vel, float y_vel, float theta_vel){
//THIS FIXED IT//
...
int main(int argc, char** argv)
{
    ...
    cmd_vel_sub  = n.subscribe<geometry_msgs::Twist>("cmd_vel", 1000, cmdVelReceived);
